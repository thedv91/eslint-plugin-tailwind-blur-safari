...
const { separatorRegEx } = require('./regex.js');

const removeDuplicatesFromArray = require('./removeDuplicatesFromArray.js');
      ...
      case 'ObjectExpression':
        childNode.properties.forEach((prop) => {
          const isUsedByClassNamesPlugin =
            rootNode.callee && rootNode.callee.name === 'classnames';
          ...
          if (
            ...
            ignoredKeys.includes(prop.key.name)
          ) {
